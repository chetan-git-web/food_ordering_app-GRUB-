...
const Contact=()=> {
  ...
  console.log(fname);
  const body = `fname : ${fname.current.value} 
  ...
  const emailsend =()=>{
    Email.send({
      ...
      Username : "chetankandala2017@gmail.com",
      Password : "5BEBCFB87B0B9A7769FF62D899FFCFDCBADF",
      To : 'chetankandala2017@gmail.com',
      From : "chetankandala2017@gmail.com",
      Subject : "Grub Contact us mail",
      Body : body
  }).then(
    message => {
      if(message === "OK"){
        alert("email sent to admin... will contact you soon");
      }
      else{
        alert("message");
      }
