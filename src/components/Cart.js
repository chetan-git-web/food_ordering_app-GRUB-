...
const CartItems = () => {
  ...
  return (
            ...
            <div className="flex justify-between">
              ...
              <div className="item-center">
                <div className="w-[100px] h-[100px] overflow-hidden rounded-xl ">
                  {item.imageId===undefined?<img className="object-cover w-[100px] h-[100px] border border-gray-700" src={alternativeimg}></img>:item.imageId === undefined ? (
                    <></>
                  ) : item.isStock !== 1 ? (
                    <img
    ...
    <div className="ml-[1320px]"><h1 className="text-[20px] ">Total:</h1>Rs {priceofitems}</div>
